...
public class MainActivity extends AppCompatActivity {
    ...
    private void initTextViews() {
        calcularTV = (TextView)findViewById(R.id.calcularTextView);
    ...
    public void equalOnClick(View view){
        ...
        try {
            ...
            resultsTV.setText("Syntax Error");
        }
    ...
    public void potencyOnClick(View view) {
        setWorkings("^");
    }
    ...
    public void eigthOnClick(View view) {
        setWorkings("8");
    }
